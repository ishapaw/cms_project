  ...
  callLoginApi() {
    ...
    service
      ...
      if (value.token != null) {
        ...
        HelperFunctions.saveuserNameSharePreference(uid);
      } else {
        ...
        body: SingleChildScrollView(
          child: Stack(children: [
            Center(
              child: Padding(
                padding:
                    const EdgeInsets.symmetric(horizontal: 20.0, vertical: 70),
                child: Column(
                  ...
                  children: [
                    Image(
                      image:
                          AssetImage('assets/images/harayana_police_logo.png'),
                      height: 120,
                    ),
                    SizedBox(
                      height: 75,
                          ...
                          SizedBox(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                prefixIcon: Image(
                                    image:
                                        AssetImage("assets/images/pas1.png")),
                                fillColor: greyLight,
                                filled: true,
                                labelStyle: TextStyle(color: greyMed),
                                floatingLabelBehavior:
